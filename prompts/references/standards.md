Method Factory reference: standards checklist.
...
> Reference content: describes what generated packages must contain and the engine's operator gates. It is NOT a directive to the conversation agent to enforce state - the code layer owns enforcement (see method-factory-core).
