Method Factory reference: intake guidance.

# references/intake.md — Intake: user-provided material (input-agnostic)

> Reference content: describes how intake treats material. It is NOT a directive to the conversation agent to enforce state - the code layer owns enforcement (see method-factory-core).
