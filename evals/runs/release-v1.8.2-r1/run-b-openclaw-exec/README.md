...
This immutable release-evidence sub-run is `release-v1.8.2-r1-run-b-openclaw-exec` for
Process Engine v1.8.2. Mirrored-dual-source protocol: executor
`turnstone-orchestrator` performed the case work; verifier `hermes-gateway` recorded
the final judgments using model `gpt-5.6-terra`. Measured window
2026-08-02T06:06:31+07:00 through 2026-08-02T07:53:57+07:00 (Asia/Bangkok, from transcript file timestamps); final
